...
// **********************  1  ************************** 
$Index_Nilai = array("A"=>1, "AB"=>2,"B"=>3,"BC"=>4,"C"=>5);

if ($_POST){
   $data_MK_KI1201 = $Index_Nilai[$_POST["MK_KI1201"]];
   $data_MK_KU1202 = $Index_Nilai[$_POST["MK_KU1202"]];
   $data_MK_KU1102 = $Index_Nilai[$_POST["MK_KU1102"]];
}
...
// silakan taruh code kalian di bawah
// **********************  2  ************************** 
    if (empty($data_MK_KI1201) || empty($data_MK_KU1202) ||  empty($data_MK_KU1102)) {
        $error = "error";
    }
